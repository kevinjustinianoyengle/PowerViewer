...
def register(app: Dash) -> None:
    ...
    def toggle_visibility(active):
        ...
        return (vis("dispersion"), vis("multi_trend"),
                opt("dispersion"), opt("multi_trend"))
