...
_RIBBON_KEYS = ["labels", "axes", "combine", "break", "marks", "view"]
_VIEW_LABEL = {"dispersion": "Distribution", "multi_trend": "Display"}
...
def register(app: Dash) -> None:
    ...
    @app.callback(
        ...
        Input("ribbon-btn-break", "n_clicks"),
    ...
    def toggle_ribbon(_l, _a, _c, _b, _m, _v, _active, current):
    ...
    def toggle_chip(_mt, _dn, _active, current):
        trig = ctx.triggered_id
    ...
    @app.callback(
        ...
        Output("ribbon-break-menu", "style"),
    ...
    def chrome(active):
        ...
        # Adjust Axes, Combine and Break are Trends-only.
        ...
        return (sec("dispersion"), sec("multi_trend"),
                multi_only, dict(multi_only), dict(multi_only), view_label)
